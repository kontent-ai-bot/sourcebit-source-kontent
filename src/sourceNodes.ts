...
const getKontentItemLanguageVariantArtifact = (kontentItem: KontentItem): KontentItem => {
...
const sourceNodes = async (options: CustomPluginOptions): Promise<Array<any>> => {

  var nodesData: Array<any> = [];
